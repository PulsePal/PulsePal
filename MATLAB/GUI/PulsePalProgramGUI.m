function varargout = PulsePalProgramGUI(varargin)
% PULSEPALPROGRAMGUI M-file for PulsePalProgramGUI.fig
%      PULSEPALPROGRAMGUI, by itself, creates a new PULSEPALPROGRAMGUI or raises the existing
%      singleton*.
%
%      H = PULSEPALPROGRAMGUI returns the handle to a new PULSEPALPROGRAMGUI or the handle to
%      the existing singleton*.
%
%      PULSEPALPROGRAMGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PULSEPALPROGRAMGUI.M with the given input arguments.
%
%      PULSEPALPROGRAMGUI('Property','Value',...) creates a new PULSEPALPROGRAMGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before PulsePalProgramGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to PulsePalProgramGUI_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @PulsePalProgramGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @PulsePalProgramGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before PulsePalProgramGUI is made visible.
function PulsePalProgramGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to PulsePalProgramGUI (see VARARGIN)
...
% UIWAIT makes PulsePalProgramGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = PulsePalProgramGUI_OutputFcn(hObject, eventdata, handles) 

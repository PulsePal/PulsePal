...
class PulsePalObject(object):
    ...
    def __init__(self):
        ...
        self.outputParameterNames = ['isBiphasic', 'phase1Voltage','phase2Voltage', 'phase1Duration', 'interPhaseInterval', 
                               ...
                               'customTrainTarget', 'customTrainLoop']
    ...
    def programTriggerChannelParam(self, paramName, channel, value):
        ...
        if isinstance(paramName, basestring):
            ...
            paramCode = paramName
        messageBytes = struct.pack('BBBB',74,paramCode,channel,value)
    ...
    def syncAllParams(self):
        ...
        # Add 8-bit params
        programValues = [0]*24; pos = 0
        for i in range(1,5):
            programValues[pos] = self.isBiphasic[i]; pos+=1
            value = ((self.phase1Voltage[i]+10)/float(20))*255 # Convert volts to bits
            programValues[pos] = value; pos+=1
            value = ((self.phase2Voltage[i]+10)/float(20))*255 # Convert volts to bits
            programValues[pos] = value; pos+=1
        ...
        programByteString = programByteString + struct.pack('BBBBBBBBBBBBBBBBBBBBBBBB', *programValues)
    ...
    def sendCustomPulseTrain(self, customTrainID, pulseTimes, pulseVoltages):
        ...
        if customTrainID == 1:
            ...
            messageBytes = chr(76) # Op code for programming train 2
    ...
    def triggerOutputChannels(self, channel1, channel2, channel3, channel4):
        ...
        messageBytes = struct.pack('BB',77,triggerByte)
        self.serialObject.write(messageBytes)
    def abortPulseTrains(self):
        messageBytes = struct.pack('B',80)
        self.serialObject.write(messageBytes) 
    def setContinuousLoop(self, channel, state):
        messageBytes = struct.pack('BBB',82, channel, state)
        self.serialObject.write(messageBytes)
